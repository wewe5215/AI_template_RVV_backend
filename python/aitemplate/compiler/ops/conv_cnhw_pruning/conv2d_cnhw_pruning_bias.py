...
class conv2d_cnhw_pruning_bias(conv2d_cnhw_pruning_bias_activation):
    r"""Conv2d with bias.
    ...
    def __init__(self, stride, pad, dilate=1, group=1, pruning_ratio=0.5) -> None:
        ...
        """
        super().__init__("identity", stride, pad, dilate=dilate, group=group, pruning_ratio=pruning_ratio)
        self._attrs["op"] = "conv2d_cnhw_pruning_bias"
