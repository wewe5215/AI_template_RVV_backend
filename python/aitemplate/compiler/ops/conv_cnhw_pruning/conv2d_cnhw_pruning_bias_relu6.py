...
class conv2d_cnhw_pruning_bias_relu6(conv2d_cnhw_pruning_bias_activation):
    ...
    def __init__(self, stride, pad, dilate=1, group=1, pruning_ratio=0.5) -> None:
        ...
        """
        super().__init__("relu6", stride, pad, dilate=dilate, group=group, pruning_ratio=pruning_ratio)
