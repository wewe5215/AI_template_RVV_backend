...
#
"""
Fused conv2d_depthwise_bias_relu6 op.
"""
...
class conv2d_cnhw_pruning_depthwise_bias_relu6(conv2d_cnhw_pruning):
    ...
    def __init__(self, stride, pad, dilate=1, group=1, pruning_ratio=0.5) -> None:
        ...
        self._attrs["op"] = "conv2d_cnhw_pruning_depthwise_bias_relu6"
