...
#
"""
Fused conv2d_bias_relu_transpose op.
"""
...
class conv2d_bias_relu_transpose(conv2d_bias_relu_activation):
    ...
    .. code-block:: python
        ...
        OP = aitemplate.compiler.ops.conv2d_bias_relu_transpose(stride=1, pad=1, dilate=1)
        Result_ait = OP(X, W, B)
    ...
    def __init__(self, stride, pad, dilate=1, group=1) -> None:
        """conv2d_bias_relu_transpose constructor.
