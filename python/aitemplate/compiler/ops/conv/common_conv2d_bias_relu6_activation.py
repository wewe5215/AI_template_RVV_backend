...
#
"""
Fused conv2d_bias_relu6_activation op.
"""
...
class conv2d_bias_relu6_activation(conv2d):
    ...
    def __init__(self, activation, stride, pad, dilate=1, group=1) -> None:
        ...
        self._attrs["op"] = "conv2d_bias_relu6_{act}".format(act=activation)
        self._attrs["epilogue"] = "LinearCombinationResidualBlock"

    def __call__(self, x: Tensor, w: Tensor, b: Tensor, r: Tensor):
        """Call conv2d_bias_relu6_activation with tensors x, w, b, r
