...
class conv2d_bias_transpose(conv2d_bias_activation):
    r"""Conv2d with bias.
    ...
    .. code-block:: python
        ...
        OP = aitemplate.compiler.ops.conv2d_bias_transpose(stride=1, pad=1, dilate=1)
        Y = OP(X, W, B)
    ...
    def __init__(self, stride, pad, dilate=1, group=1) -> None:
        """conv2d_bias_transpose constructor.
        ...
        self._attrs["op"] = "conv2d_bias_transpose"
