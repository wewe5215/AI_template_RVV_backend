...
class Conv2dPruningKind(enum.Enum):
    Conv2dPruning = auto()
...
Conv2dPruningKindNames = {
    Conv2dPruningKind.Conv2dPruning: "conv2d_pruning",
    Conv2dPruningKind.Conv2dPruningBias: "conv2d_pruning_bias",
    Conv2dPruningKind.Conv2dPruningBiasAdd: "conv2d_pruning_bias_add",
    Conv2dPruningKind.Conv2dPruningBiasRelu: "conv2d_pruning_bias_relu",
    Conv2dPruningKind.Conv2dPruningBiasRelu6: "conv2d_pruning_bias_relu6",
    Conv2dPruningKind.Conv2dPruningBiasAddRelu: "conv2d_pruning_bias_add_relu",
    Conv2dPruningKind.Conv2dPruningBiasAddRelu6: "conv2d_pruning_bias_add_relu6",
    Conv2dPruningKind.Conv2dPruningBiasReluAdd: "conv2d_pruning_bias_relu_add",
    Conv2dPruningKind.Conv2dPruningBiasRelu6Add: "conv2d_pruning_bias_relu6_add",
    Conv2dPruningKind.Conv2dPruningBiasSigmoid: "conv2d_pruning_bias_sigmoid",
}
