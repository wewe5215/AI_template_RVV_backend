...
@registry.reg("rvv.slice_scatter.func_decl")
def gen_function_decl(func_attrs):
    ...
    """
    return slice_common.gen_function_decl(func_attrs, RVVSpec())


@registry.reg("rvv.slice_scatter.gen_function")
...
@registry.reg("rvv.slice_scatter.func_call")
