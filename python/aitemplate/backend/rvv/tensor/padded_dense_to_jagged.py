...
@registry.reg("rvv.padded_dense_to_jagged.gen_function")
...
@registry.reg("rvv.padded_dense_to_jagged.func_decl")
...
@registry.reg("rvv.padded_dense_to_jagged.func_call")
