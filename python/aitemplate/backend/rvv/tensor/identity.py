...
@registry.reg("rvv.identity.func_decl")
def gen_function_decl(func_attrs):
    ...
    return identity_common.gen_function_decl(
        func_attrs=func_attrs, backend_spec=RVVSpec()
    )


@registry.reg("rvv.identity.gen_function")
def gen_function(func_attrs):
    ...
    """
    return identity_common.gen_function(func_attrs=func_attrs, backend_spec=RVVSpec())


@registry.reg("rvv.identity.func_call")
