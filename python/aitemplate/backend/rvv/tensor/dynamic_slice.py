...
@registry.reg("rvv.dynamic_slice.func_decl")
def gen_function_decl(func_attrs):
    ...
    """
    return slice_common.gen_function_decl(func_attrs, backend_spec=RVVSpec())


@registry.reg("rvv.dynamic_slice.gen_function")
def gen_function(func_attrs):
    ...
    return slice_common.gen_function(
        func_attrs, backend_spec=RVVSpec(), elems_per_thread=8
    )


@registry.reg("rvv.dynamic_slice.func_call")
