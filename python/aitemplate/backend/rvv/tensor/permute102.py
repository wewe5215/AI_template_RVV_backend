...
@registry.reg("rvv.permute102.gen_function")
...
@registry.reg("rvv.permute102.func_decl")
def gen_function_decl(func_attrs):
    ...
    """
    return permute102_common.gen_function_decl(func_attrs, RVVSpec())


@registry.reg("rvv.permute102.func_call")
def gen_function_call(func_attrs, indent="  "):
    ...
    """
    return permute102_common.gen_function_call(func_attrs, RVVSpec(), indent)
