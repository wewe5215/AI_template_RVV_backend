...
@registry.reg("rvv.permute0213.gen_function")
...
@registry.reg("rvv.permute0213.func_decl")
def gen_function_decl(func_attrs):
    ...
    """
    return permute0213_common.gen_function_decl(func_attrs, RVVSpec())


@registry.reg("rvv.permute0213.func_call")
def gen_function_call(func_attrs, indent="  "):
    ...
    """
    return permute0213_common.gen_function_call(func_attrs, RVVSpec(), indent)
