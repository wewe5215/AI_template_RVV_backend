...
@registry.reg("rvv.permute.gen_function")
def gen_function(func_attrs: Dict[str, Any]) -> str:
    ...
    backend_type = RVVSpec().dtype_to_backend_dtype[dtype]
...
@registry.reg("rvv.permute.func_decl")
...
@registry.reg("rvv.permute.func_call")
