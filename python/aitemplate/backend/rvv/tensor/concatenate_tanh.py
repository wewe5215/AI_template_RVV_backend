...
from aitemplate.backend.rvv.tensor import concatenate
...
@registry.reg("rvv.concatenate_tanh.func_decl")
def gen_function_decl(func_attrs):
    return concatenate.gen_function_decl(func_attrs)


@registry.reg("rvv.concatenate_tanh.gen_function")
...
@registry.reg("rvv.concatenate_tanh.func_call")
