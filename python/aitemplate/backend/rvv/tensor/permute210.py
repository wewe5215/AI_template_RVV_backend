...
@registry.reg("rvv.permute210.gen_function")
def gen_function(func_attrs, template_path):
    ...
    """
    return permute210_common.gen_function(func_attrs, Header_files, RVVSpec())


@registry.reg("rvv.permute210.func_decl")
def gen_function_decl(func_attrs):
    return permute210_common.gen_function_decl(func_attrs, RVVSpec())


@registry.reg("rvv.permute210.func_call")
def gen_function_call(func_attrs, indent="  "):
    ...
    """
    return permute210_common.gen_function_call(func_attrs, RVVSpec(), indent)
