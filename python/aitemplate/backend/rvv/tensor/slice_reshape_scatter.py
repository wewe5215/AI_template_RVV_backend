...
@registry.reg("rvv.slice_reshape_scatter.func_decl")
def gen_function_decl(func_attrs):
    ...
    """
    return slice_reshape_scatter_common.gen_function_decl(func_attrs, RVVSpec())


@registry.reg("rvv.slice_reshape_scatter.gen_function")
def gen_function(func_attrs, element_func=None):
    ...
    return slice_reshape_scatter_common.gen_function(
        func_attrs, RVVSpec(), TANH_DEF, element_func, EXTRA_HEADER_TEMPLATE
    )


@registry.reg("rvv.slice_reshape_scatter.func_call")
