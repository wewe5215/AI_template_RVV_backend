...
@registry.reg("rvv.jagged_to_padded_dense.gen_function")
...
@registry.reg("rvv.jagged_to_padded_dense.func_decl")
...
@registry.reg("rvv.jagged_to_padded_dense.func_call")
