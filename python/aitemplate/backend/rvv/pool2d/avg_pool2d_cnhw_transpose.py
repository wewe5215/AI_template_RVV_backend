...
#
"""
RVV avg_pool2d_cnhw_transpose funcs
"""
from aitemplate.backend import registry
from aitemplate.backend.rvv.pool2d import pool2d


@registry.reg("rvv.avg_pool2d_cnhw_transpose.gen_function")
...
@registry.reg("rvv.avg_pool2d_cnhw_transpose.func_decl")
def avg_pool2d_gen_function_decl(func_attrs):
    func_name = func_attrs["name"]
    return pool2d.gen_function_decl(func_name)


@registry.reg("rvv.avg_pool2d_cnhw_transpose.func_call")
