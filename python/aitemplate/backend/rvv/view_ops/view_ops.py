...
#
"""
rvv codegen functions for view ops.
"""
import jinja2
...
@registry.reg("rvv.reshape.gen_function")
@registry.reg("rvv.flatten.gen_function")
...
@registry.reg("rvv.reshape.func_decl")
@registry.reg("rvv.flatten.func_decl")
...
@registry.reg("rvv.reshape.func_call")
@registry.reg("rvv.flatten.func_call")
...
@registry.reg("rvv.squeeze.gen_function")
@registry.reg("rvv.unsqueeze.gen_function")
...
@registry.reg("rvv.squeeze.func_decl")
@registry.reg("rvv.unsqueeze.func_decl")
...
@registry.reg("rvv.squeeze.func_call")
@registry.reg("rvv.unsqueeze.func_call")
def squeeze_gen_function_call(func_attrs, indent="  "):
    ...
    func_attrs : Dict[str, Any]
        The _attrs dict from the original op.
    ident : str
        Sequence to use to generate the indentations in the rvv code
    """
    func_name = func_attrs["name"]
    input_names = [
        shape._attrs["name"] for shape in func_attrs["inputs"][0]._attrs["shape"]
