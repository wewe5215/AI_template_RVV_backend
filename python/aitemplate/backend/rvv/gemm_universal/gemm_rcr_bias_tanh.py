...
@registry.reg("rvv.gemm_rcr_bias_tanh.config")
...
@registry.reg("rvv.gemm_rcr_bias_tanh.gen_profiler")
...
@registry.reg("rvv.gemm_rcr_bias_tanh.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
