...
from aitemplate.backend.rvv.gemm_universal.bmm_xxx import _get_problem_args, get_config
...
for a_layout in ["c", "r"]:
    for b_layout in ["c", "r"]:
        for c_layout in ["c", "r"]:
            prefix = f"rvv.bmm_{a_layout}{b_layout}{c_layout}_add."
