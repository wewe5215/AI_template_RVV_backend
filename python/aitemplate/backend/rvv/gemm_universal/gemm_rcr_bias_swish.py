...
@registry.reg("rvv.gemm_rcr_bias_swish.config")
...
@registry.reg("rvv.gemm_rcr_bias_swish.gen_profiler")
...
@registry.reg("rvv.gemm_rcr_bias_swish.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
