...
@registry.reg("rvv.gemm_rcr_fast_gelu.config")
def gemm_rcr_config(func_attrs, dtype="float16"):
    common.make_fproc(func_attrs, RCR, include_cutlass_3x_ops=True)


@registry.reg("rvv.gemm_rcr_fast_gelu.gen_profiler")
...
@registry.reg("rvv.gemm_rcr_fast_gelu.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
