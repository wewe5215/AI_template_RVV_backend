...
@registry.reg("rvv.perm021fc_crc.config")
...
@registry.reg("rvv.perm021fc_crc.gen_profiler")
...
@registry.reg("rvv.perm021fc_crc.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.perm021fc_crc.func_decl")
def gen_function_decl(func_attrs):
    return bmm_common.gen_function_decl(func_attrs)


@registry.reg("rvv.perm021fc_crc.func_call")
def gen_function_call(func_attrs, indent="  "):
    return bmm_common.gen_function_call(func_attrs, indent)


@registry.reg("rvv.perm021fc_crc.filter")
