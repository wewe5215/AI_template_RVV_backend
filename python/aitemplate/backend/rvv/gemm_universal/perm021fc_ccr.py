...
@registry.reg("rvv.perm021fc_ccr.config")
...
@registry.reg("rvv.perm021fc_ccr.gen_profiler")
...
@registry.reg("rvv.perm021fc_ccr.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.perm021fc_ccr.func_decl")
def gen_function_decl(func_attrs):
    return bmm_common.gen_function_decl(func_attrs)


@registry.reg("rvv.perm021fc_ccr.func_call")
def gen_function_call(func_attrs, indent="  "):
    return bmm_common.gen_function_call(func_attrs, indent)


@registry.reg("rvv.perm021fc_ccr.filter")
