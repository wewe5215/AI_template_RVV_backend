...
@registry.reg("rvv.gemm_rrr.config")
...
@registry.reg("rvv.gemm_rrr.gen_profiler")
...
@registry.reg("rvv.gemm_rrr.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.gemm_rrr.func_decl")
...
@registry.reg("rvv.gemm_rrr.func_call")
def gen_function_call(func_attrs, indent="  "):
    return common.gen_function_call(func_attrs, indent)


@registry.reg("rvv.gemm_rrr.filter")
