...
from aitemplate.backend.rvv.gemm_universal import bmm_common, common
from aitemplate.backend.rvv.gemm_universal.perm102_bmm_rcr import (
...
@registry.reg("rvv.perm102_bmm_rrr.config")
...
@registry.reg("rvv.perm102_bmm_rrr.gen_profiler")
...
@registry.reg("rvv.perm102_bmm_rrr.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.perm102_bmm_rrr.func_decl")
def gen_function_decl(func_attrs):
    return bmm_common.gen_function_decl(func_attrs)


@registry.reg("rvv.perm102_bmm_rrr.func_call")
def gen_function_call(func_attrs, indent="  "):
    return bmm_common.gen_function_call(func_attrs, indent)


@registry.reg("rvv.perm102_bmm_rrr.filter")
