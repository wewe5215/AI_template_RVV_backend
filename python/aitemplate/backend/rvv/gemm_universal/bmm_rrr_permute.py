...
@registry.reg("rvv.bmm_rrr_permute.config")
...
@registry.reg("rvv.bmm_rrr_permute.gen_profiler")
...
@registry.reg("rvv.bmm_rrr_permute.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
