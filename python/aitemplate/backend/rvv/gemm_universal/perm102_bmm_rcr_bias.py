...
@registry.reg("rvv.perm102_bmm_rcr_bias.config")
def gemm_rcr_config(func_attrs, dtype="float16"):
    return perm102_bmm_rcr.gemm_rcr_config(func_attrs, dtype)


@registry.reg("rvv.perm102_bmm_rcr_bias.gen_profiler")
...
@registry.reg("rvv.perm102_bmm_rcr_bias.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.perm102_bmm_rcr_bias.func_decl")
...
@registry.reg("rvv.perm102_bmm_rcr_bias.func_call")
...
@registry.reg("rvv.perm102_bmm_rcr_bias.filter")
