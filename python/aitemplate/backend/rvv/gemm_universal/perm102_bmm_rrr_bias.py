...
@registry.reg("rvv.perm102_bmm_rrr_bias.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.perm102_bmm_rrr_bias.func_decl")
...
@registry.reg("rvv.perm102_bmm_rrr_bias.func_call")
...
@registry.reg("rvv.perm102_bmm_rrr_bias.filter")
