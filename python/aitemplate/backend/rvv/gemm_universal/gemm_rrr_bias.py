...
from aitemplate.backend.rvv.gemm_universal import common, common_bias, gemm_rrr
from aitemplate.backend.rvv.gemm_universal.layout import RRR
...
@registry.reg("rvv.gemm_rrr_bias.config")
def gemm_rrr_config(func_attrs, dtype="float16"):
    common.make_fproc(func_attrs, RRR)


@registry.reg("rvv.gemm_rrr_bias.gen_profiler")
...
@registry.reg("rvv.gemm_rrr_bias.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.gemm_rrr_bias.func_decl")
...
@registry.reg("rvv.gemm_rrr_bias.func_call")
...
@registry.reg("rvv.gemm_rrr_bias.filter")
