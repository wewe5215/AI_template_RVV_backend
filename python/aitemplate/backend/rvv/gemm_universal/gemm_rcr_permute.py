...
from aitemplate.backend.rvv.gemm_universal import common, common_permute
...
@registry.reg("rvv.gemm_rcr_permute.config")
...
@registry.reg("rvv.gemm_rcr_permute.gen_profiler")
...
@registry.reg("rvv.gemm_rcr_permute.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.gemm_rcr_permute.func_decl")
...
@registry.reg("rvv.gemm_rcr_permute.func_call")
...
@registry.reg("rvv.gemm_rcr_permute.filter")
