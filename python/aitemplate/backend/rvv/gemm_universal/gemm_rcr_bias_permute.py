...
@registry.reg("rvv.gemm_rcr_bias_permute.config")
...
@registry.reg("rvv.gemm_rcr_bias_permute.gen_profiler")
...
@registry.reg("rvv.gemm_rcr_bias_permute.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.gemm_rcr_bias_permute.func_decl")
...
@registry.reg("rvv.gemm_rcr_bias_permute.func_call")
...
@registry.reg("rvv.gemm_rcr_bias_permute.filter")
