...
@registry.reg("rvv.perm102_bmm_rcr.config")
...
@registry.reg("rvv.perm102_bmm_rcr.gen_profiler")
...
@registry.reg("rvv.perm102_bmm_rcr.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.perm102_bmm_rcr.func_decl")
def gen_function_decl(func_attrs):
    return bmm_common.gen_function_decl(func_attrs)


@registry.reg("rvv.perm102_bmm_rcr.func_call")
def gen_function_call(func_attrs, indent="  "):
    return bmm_common.gen_function_call(func_attrs, indent)


@registry.reg("rvv.perm102_bmm_rcr.filter")
