...
from aitemplate.backend.rvv.gemm_universal import common, common_bias_activation
...
@registry.reg("rvv.gemm_rcr_bias_fast_gelu.config")
...
@registry.reg("rvv.gemm_rcr_bias_fast_gelu.gen_profiler")
...
@registry.reg("rvv.gemm_rcr_bias_fast_gelu.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.gemm_rcr_bias_fast_gelu.func_decl")
def gen_function_decl(func_attrs):
    return common_bias_activation.gen_function_decl(func_attrs)


@registry.reg("rvv.gemm_rcr_bias_fast_gelu.func_call")
def gen_function_call(func_attrs, indent="  "):
    return common_bias_activation.gen_function_call(func_attrs, indent)


@registry.reg("rvv.gemm_rcr_bias_fast_gelu.filter")
