...
@registry.reg("rvv.group_gemm_rcr_bias.config")
def group_rcr_config(func_attrs):
    group_gemm_rcr.group_rcr_config(func_attrs)


@registry.reg("rvv.group_gemm_rcr_bias.gen_profiler")
...
@registry.reg("rvv.group_gemm_rcr_bias.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    shape_eval_template,
...
@registry.reg("rvv.group_gemm_rcr_bias.func_decl")
def gen_function_decl(func_attrs):
    return group_common_bias.gen_function_decl(func_attrs)


@registry.reg("rvv.group_gemm_rcr_bias.func_call")
def gen_function_call(func_attrs, indent="  "):
    return group_common_bias.gen_function_call(func_attrs, indent)


@registry.reg("rvv.group_gemm_rcr_bias.filter")
