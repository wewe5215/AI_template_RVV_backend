...
@registry.reg("rvv.perm021fc_crc_bias.config")
def gemm_rcr_config(func_attrs, dtype="float16"):
    return perm021fc_crc.gemm_crc_config(func_attrs, dtype)


@registry.reg("rvv.perm021fc_crc_bias.gen_profiler")
...
@registry.reg("rvv.perm021fc_crc_bias.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    dim_info_dict,
...
@registry.reg("rvv.perm021fc_crc_bias.func_decl")
...
@registry.reg("rvv.perm021fc_crc_bias.func_call")
...
@registry.reg("rvv.perm021fc_crc_bias.filter")
