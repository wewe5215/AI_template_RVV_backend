...
from aitemplate.backend.rvv.gemm_universal import gemm_rcr_permute
...
@registry.reg("rvv.gemm_rcr_permute_elup1.config")
...
@registry.reg("rvv.gemm_rcr_permute_elup1.gen_profiler")
...
@registry.reg("rvv.gemm_rcr_permute_elup1.gen_function")
...
@registry.reg("rvv.gemm_rcr_permute_elup1.filter")
