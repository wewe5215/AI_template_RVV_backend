...
@registry.reg("rvv.conv2d_depthwise_bias_transpose.config")
def conv2d_depthwise_config(func_attrs, dtype="float16"):
    """Populates conv2d_depthwise configs into 'op_instance' field."""
    import cpu_lib
    op_kind = cpu_lib.library.Conv2dKind.Conv2dDepthwiseBiasTranspose
...
@registry.reg("rvv.conv2d_depthwise_bias_transpose.gen_profiler")
def gen_profiler(func_attrs, workdir, profiler_filename, shape_template):
    """Codegen for conv2d_depthwise_bias_transpose profiler."""
...
@registry.reg("rvv.conv2d_depthwise_bias_transpose.gen_function")
def gen_function(
    func_attrs,
    exec_cond_template,
    shape_eval_template,
    ...
    """Codegen for conv2d_depthwise_bias_transpose function."""
...
@registry.reg("rvv.conv2d_depthwise_bias_transpose.func_decl")
def conv2d_depthwise_gen_function_decl(func_attrs):
    """Codegen for conv2d_depthwise_bias_transpose function declaration."""
...
@registry.reg("rvv.conv2d_depthwise_bias_transpose.func_call")
def conv2d_depthwise_gen_function_call(func_attrs, indent="  "):
    """Codegen for conv2d_depthwise_bias_transpose function call."""
...
@registry.reg("rvv.conv2d_depthwise_bias_transpose.filter")
