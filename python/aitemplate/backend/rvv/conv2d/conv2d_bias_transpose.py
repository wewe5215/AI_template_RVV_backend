...
@registry.reg("rvv.conv2d_bias_transpose.config")
def conv2d_bias_config(
    ...
    import cpu_lib
    op_kind = cpu_lib.library.Conv2dKind.Conv2dBiasTranspose
...
@registry.reg("rvv.conv2d_bias_transpose.gen_profiler")
...
@registry.reg("rvv.conv2d_bias_transpose.gen_function")
...
@registry.reg("rvv.conv2d_bias_transpose.func_decl")
...
@registry.reg("rvv.conv2d_bias_transpose.func_call")
...
@registry.reg("rvv.conv2d_bias_transpose.filter")
