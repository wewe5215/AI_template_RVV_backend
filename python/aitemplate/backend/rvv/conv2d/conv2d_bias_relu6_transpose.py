...
@registry.reg("rvv.conv2d_bias_relu6_transpose.config")
def conv2d_bias_relu_config(
    func_attrs,
    dtype="float16",
):
    import cpu_lib
    op_kind = cpu_lib.library.Conv2dKind.Conv2dBiasRelu6Transpose
...
@registry.reg("rvv.conv2d_bias_relu6_transpose.gen_profiler")
...
@registry.reg("rvv.conv2d_bias_relu6_transpose.gen_function")
...
@registry.reg("rvv.conv2d_bias_relu6_transpose.func_decl")
...
@registry.reg("rvv.conv2d_bias_relu6_transpose.func_call")
...
@registry.reg("rvv.conv2d_bias_relu6_transpose.filter")
