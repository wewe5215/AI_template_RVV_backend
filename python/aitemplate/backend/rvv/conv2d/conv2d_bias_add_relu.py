...
@registry.reg("rvv.conv2d_bias_add_relu.config")
...
@registry.reg("rvv.conv2d_bias_add_relu.gen_profiler")
...
@registry.reg("rvv.conv2d_bias_add_relu.gen_function")
...
@registry.reg("rvv.conv2d_bias_add_relu.func_decl")
...
@registry.reg("rvv.conv2d_bias_add_relu.func_call")
...
@registry.reg("rvv.conv2d_bias_add_relu.filter")
