...
@registry.reg("rvv.conv2d_bias.config")
...
@registry.reg("rvv.conv2d_bias.gen_profiler")
...
@registry.reg("rvv.conv2d_bias.gen_function")
...
@registry.reg("rvv.conv2d_bias.func_decl")
...
@registry.reg("rvv.conv2d_bias.func_call")
...
@registry.reg("rvv.conv2d_bias.filter")
