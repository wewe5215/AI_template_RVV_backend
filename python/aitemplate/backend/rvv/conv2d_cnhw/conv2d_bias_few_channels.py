...
@registry.reg("rvv.conv2d_bias_few_channels.config")
...
@registry.reg("rvv.conv2d_bias_few_channels.gen_profiler")
...
@registry.reg("rvv.conv2d_bias_few_channels.gen_function")
...
@registry.reg("rvv.conv2d_bias_few_channels.func_decl")
...
@registry.reg("rvv.conv2d_bias_few_channels.func_call")
...
@registry.reg("rvv.conv2d_bias_few_channels.filter")
