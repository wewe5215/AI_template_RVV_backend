...
@registry.reg("rvv.conv2d_cnhw_bias_relu6.config")
def conv2d_bias_relu_config(
    func_attrs,
    dtype="float16",
):
    import cpu_lib
    op_kind = cpu_lib.library.Conv2dKind.Conv2dBiasRelu6
...
@registry.reg("rvv.conv2d_cnhw_bias_relu6.gen_profiler")
...
@registry.reg("rvv.conv2d_cnhw_bias_relu6.gen_function")
...
@registry.reg("rvv.conv2d_cnhw_bias_relu6.func_decl")
...
@registry.reg("rvv.conv2d_cnhw_bias_relu6.func_call")
...
@registry.reg("rvv.conv2d_cnhw_bias_relu6.filter")
