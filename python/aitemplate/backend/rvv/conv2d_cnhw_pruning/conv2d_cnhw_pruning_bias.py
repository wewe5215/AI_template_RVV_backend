...
@registry.reg("rvv.conv2d_cnhw_pruning_bias.config")
...
@registry.reg("rvv.conv2d_cnhw_pruning_bias.gen_profiler")
...
@registry.reg("rvv.conv2d_cnhw_pruning_bias.gen_function")
...
@registry.reg("rvv.conv2d_cnhw_pruning_bias.func_decl")
...
@registry.reg("rvv.conv2d_cnhw_pruning_bias.func_call")
...
@registry.reg("rvv.conv2d_cnhw_pruning_bias.filter")
