...
void conv2d_bias_add_relu_28 (
  ...
  *out_ch = CO;
  ...
  //conv2d_bias_add_relu_1_f32_f32_f32
  ...
  xnn_operator_t binary_func_minmax_flag_op = nullptr;

  CHECK_EQ(xnn_status_success, xnn_create_add_nd_f32(0, std::numeric_limits<float>::infinity(), 0, &binary_func_minmax_flag_op));

  std::unique_ptr<xnn_operator, decltype(&xnn_delete_operator)> auto_binary_func_minmax_flag_op(binary_func_minmax_flag_op, xnn_delete_operator);
  ...
  xnn_status_success, xnn_reshape_add_nd_f32(
                          binary_func_minmax_flag_op, 4, a_shape, 4, b_shape,
                          /*threadpool=*/pthreadpool_));
  CHECK_EQ(
    xnn_status_success, xnn_setup_add_nd_f32(binary_func_minmax_flag_op, (float*)(res_ptr), (float*)(out_ptr), (float*)(out_ptr)));
  CHECK_EQ(xnn_status_success, xnn_run_operator(binary_func_minmax_flag_op, /*threadpool=*/pthreadpool_));
