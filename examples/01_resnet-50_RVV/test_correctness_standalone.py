...
import torch
import numpy as np
golden_file = "output_file_resnet50_4.npz"
test_file = "output_file_revised_cnhw_resnet50_4.npz"
...
torch.testing.assert_close(
    torch.from_numpy(y_test.reshape([batch_size, 1000])), torch.from_numpy(y_gold.reshape([batch_size, 1000])), rtol=0.1, atol=0.1
)
# print("my answer:")
