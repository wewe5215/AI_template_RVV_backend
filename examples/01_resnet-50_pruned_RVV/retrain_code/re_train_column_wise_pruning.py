...
pruning_ratio = 0.75
resnet_depth = 101  # Change this to 18, 34, 50, 101, or 152
...
layers_not_to_prune_resnet_18_34 = [
    ...
    'layer2.0.conv1.weight', 'layer2.0.downsample.0.weight',
...
def perform_pruning(model, pruning_ratio=0.5, depth=50):
    ...
    for layer_name, module in model.named_modules():
        ...
        # same skip logic, but match against layer_name, not full_name
