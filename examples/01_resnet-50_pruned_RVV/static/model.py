...
from model_utils import dtype_str_to_enum
from model_utils import is_linux, is_windows, is_macos
from model_utils import torch_dtype_to_string, write_tensor_binary
...
class Model:
    ...
    def memcpy(
        ...
        """
        Helper function for copying memory on the cpu. Can be useful if
    ...
    def numpy_to_ait_data(
        ...
        The allocated buffer should be manually freed.
