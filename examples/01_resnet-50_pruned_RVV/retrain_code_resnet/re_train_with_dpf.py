...
# you can fillin your model name
model_name = "cnhw_pruned_50_resnet50_1"
...
def apply_map_masks(model: nn.Module, p_ratio: float):
    ...
    for step, (images, labels) in enumerate(progress_bar):
        ...
        if epoch >= WARMUP_EPOCHS and (global_step + 1) % args.frequency == 0 and (epoch + 1) <= TOTAL_EPOCHS:
            ...
            if target_sparsity > 0:
                apply_map_masks(model, target_sparsity)
