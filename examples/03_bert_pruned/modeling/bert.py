...
class BertIntermediate(nn.Module):
    def __init__(self, hidden_size, intermediate_size, hidden_act):
        super().__init__()
        # dense + activation
        self.dense = nn.LinearPruning(
            hidden_size, intermediate_size, specialization=hidden_act, pruning_ratio=pruning_ratio
        )
...
class BertOutput(nn.Module):
    def __init__(
        ...
        # dense + add
        self.dense = nn.LinearPruning(intermediate_size, hidden_size, specialization="add", pruning_ratio=pruning_ratio)
