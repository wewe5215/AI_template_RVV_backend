...
def load_data(batch_size):
    weights_file = f"static/DenseNet121_weights_file.npz"
    io_file = f"static/DenseNet121_io_tensors_{batch_size}.npz"
...
@click.command()
@click.option("--model-name", type=str, default="densenet121", help="Model name to use")
@click.option(
    "--use-fp16-acc",
    type=bool,
    default=False,
